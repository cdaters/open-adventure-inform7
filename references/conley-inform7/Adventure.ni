...
The Building is east from End of Road. 
	...
	Instead of going downstream in the Building:
		say "The stream [flow] out through a pair of 1 foot diameter sewer pipes. It would be advisable to use the door."
	...
	A bottle is a thing in the Building with printed name "bottle of water". 
		...
		Instead of drinking the bottle when the bottle is full:
...
The Awkward Sloping East/West Canyon East/West Canyon is west of Debris Room. 
	"[We] [are] in an awkward sloping east/west canyon.[/b]".
	Down is Debris Room. 
	Inside from Debris Room is east from Awkward Sloping East/West Canyon.
	Stream's End is depressive from Awkward Sloping East/West Canyon. 
	Debris Room is debrisward from Awkward Sloping East/West Canyon.
	Understand "canyon" as west when the location is Debris Room.
	
Chapter 5 - Bird chamber

The Bird Chamber is west of the Awkward Sloping East/West Canyon. In Bird Chamber are a scenery, privately-named, plural-named thing called walls. To exit is a verb.
	...
	Inside from Awkward Sloping East/West Canyon, up from Awkward Sloping East/West Canyon
...
Part III - Hall of Hall of Mists, East

Chapter 1 - The hall

The Hall of Hall of Mists is west from the steps. To blow is a verb.
	...
	The short description is "[We]['re] in Hall of Hall of Mists."
	Instead of going by keyword pit-word in Hall of Hall of Mists, try going east. 
	Instead of going up in Hall of Hall of Mists, try going east.
	Understand "dome" and "[passa]" as east when the location is Hall of Mists. 
	
Chapter 2 - Nugget of gold room

The Nugget of Nugget of Gold Room is south from the Hall of Hall of Mists. 
	"This [are] a low room[/b] with a crude note on the wall. [It] [say] [']You won't get it up the steps[']." 
	The short description is "[We]['re] in Nugget of Nugget of Gold Room."
	Outside from Nugget of Nugget of Gold Room,
	 back from Nugget of Nugget of Gold Room are south from Hall of Hall of Mists.
	Understand "hall" as north when the location is Nugget of Gold Room.
	Understand "left" as south when the location is the Hall of Hall of Mists. 

	The sparkling gold nugget is in the Nugget of Gold Room. 
		...
		Before going through the steps
		 when the sparkling nugget is carried:
			we will look later;
			if the location is Hall of Hall of Mists,
...
The East Bank of Fissure of Fissure is west from the Hall of Hall of Mists. 
	...
	The short description is "[We]['re] on East Bank of Fissure of Fissure."
	East Bank of Fissure is forward from the Hall of Hall of Mists.
	Understand "hall" as east when the location is the East Bank of Fissure. 
	Understand "hall" as west when the location is Hall of Hall of Mists. 

	The fissure-door is a privately-named, closed, unopenable scenery door,
	 west from the East Bank of Fissure. To span is a verb.
		...
		Instead of jumping in East Bank of Fissure, try going west. 
		Instead of going inside in the East Bank of Fissure, try going west. 
		
		Before going through the closed fissure-door: 
			we will look later; 
			say "There [are] no way across the fissure." instead. 
			
		Instead of going forward in the East Bank of Fissure, 
		...
		Understand "magic/over/across" as west
		 when the location is the East Bank of Fissure. 
...
The Hall of Hall of Mt King is below the Hall of Hall of Mists. "[We] [are] in the Hall of the Mountain King,[/b] with passages off in all directions."
	The short description is "[We]['re] in Hall of Hall of Mt King."
	East from the Hall of Hall of Mt King is north from the Hall of Hall of Mists.
	Understand "stair/stairs/staircase" as "[stair]". 
	Understand "[stair]" as east when the location is Hall of Mt King. 
	Understand "[stair]" as down when the location is Hall of Mists. 

	To bar is a verb.
	The huge green fierce snake is an animal in Hall of Mt King. "[A huge green fierce snake] [bar] the way!"
	
		Going north in Hall of Mt King is moving dangerously. 
		Going west in Hall of Mt King is moving dangerously. 
		Going south in Hall of Mt King is moving dangerously. 
		Going forward in Hall of Mt King is moving dangerously. 
		...
		Instead of dropping the little bird when the snake is obvious:
			...
			now the little bird is in Hall of Mt King;
...
The Low N/S Passage Passage is north from Hall of Mt King. 
	"[We] [are] in a low N/S passage[/b] at a hole in the floor." 
	Outside from the Low Passage is north from Hall of Mt King. 
	Understand "hall" as south when the location is Low Passage. 
	Understand "hole" as down when the location is Low Passage.
	Understand "left" as north when the location is Hall of Mt King. 
...
The South Side Chamber is south from Hall of Mt King. 
	"[We] [are] in the south side chamber.[/b]".
	Outside from South Side Chamber is south from Hall of Mt King. 
	Understand "hall" as north when the location is South Side Chamber.
	Understand "right" as south when the location is Hall of Mt King. 

	Some precious jewelry is in the South Side Chamber. "There [are] precious jewelry [here]!"

The West Side Chamber is west from Hall of Mt King. To continue is a verb.
	"[We] [are] in the west side chamber[/b] of Hall of Hall of Mt King. A passage [regarding it][continue] west and up [here]."
	Outside from West Side Chamber is west from Hall of Mt King. 
	Forward from Hall of Mt King is east from West Side Chamber.
	Understand "hall" as east when the location is West Side Chamber.

	Some coins are in the West Side Chamber. "There [regarding coins][are] many coins [here]!"	
...
Down from Jumble of Rock is east from Y2. 
	...
	Above is Hall of Hall of Mists.
	Y2wards from Hall of Hall of Mists is Jumble of Rock.
...
The Dirty Passage is below Low N/S Passage Passage. 
...
The Dusty Rock Room is west from the Dirty Passage.
	...
	Understand "hole/floor" as down when the location is Dusty Rock Room.

Part V - Hall of Hall of Mists, West

Chapter 1 - West side of mists

The West Side of the Fissure is inside from the fissure-door.
	"[We] [are] on the west side of the fissure[/b] in the Hall of Hall of Mists." 
	Instead of retreating in West Side of the Fissure, try going outside.
	Understand "hall" as outside when the location is West Side of the Fissure. 
	...
	Rule for choosing notable locale objects for West Side of the Fissure: 
		set the locale priority of the fissure-door to 0;
		continue the activity. 
	
	There are some diamonds in West Side of the Fissure. "[There] [regarding diamonds][are] [diamonds] [here]!"

West End of Hall of Hall of Mists is west from West Side of the Fissure. 
	"[We] [are] at the west end of Hall of Hall of Mists.[/b] A low wide crawl [regarding it][continue] west and another [go] north. To the south [are] a little passage 6 feet off the floor." 
	The short description is "[We]['re] at West End of Hall of Hall of Mists."
...
A low wide passage is a kind of room. 
	...
	The description of a low wide passage is usually "[We] [singular have] crawled through a very low wide passage[/b] parallel to and north of the Hall of Hall of Mists." 
...
Low Wide Passage 1 is a low wide passage, north from West End of Hall of Mists. 
...
Low Wide Passage 2 is a low wide passage, north from West Side of the Fissure. 
	The connected room is West End of Hall of Mists.
		
Chapter 3 - Long hall

East End of Long Hall is west from West End of Hall of Mists. To slant is a verb.
	...
	Up is West End of Hall of Mists.
	Understand "crawl" as west when the location is West End of Hall of Mists. 

West End of Long Hall is west from East End of Long.
	"[We] [are] at the west end of a very long featureless hall.[/b]".
	Outside from West End of Long Hall is west from East End of Long Hall.
...
Maze 1 is a mazing room. West from Maze 1 is up from West End of Hall of Mists. 
	Instead of going south in West End of Hall of Mists, try going up. 
	[Positioning Maze 1 south from West End of Hall of Mists wrecks the Inform 7 index map.
	...
	Understand "climb" and "[passa]" as up
	 when the location is West End of Hall of Hall of Mists. 
...
The Crossover is west of the West Side Chamber.
	"[We] [are] at a crossover[/b] of a high N/S passage and a low E/W one."
	South is the Hall of Hall of Mists. 
	Crossover is below West Side Chamber. Up is nowhere.
	West from Crossover is down from East End of Long Hall,
	 north from the East End of Long Hall. 
	Crossover is towards crossover from Hall of Hall of Mists.
...
Bedquilt is west from Complex Junction.
	...
	Instead of going up in Bedquilt: 
		transport the player randomly to Bedquilt with likelihood 8
		 or to Secret N/S Canyon with likelihood 1 or to Dusty Rock Room; 
		rule succeeds.
	
Chapter 4 - Swiss room

Northeast from Swiss Cheese Room Room is west from Bedquilt. To resemble is a verb.
	...
	The short description is "[We]['re] in Swiss Cheese Room Room."
	
	Instead of going north in Swiss Cheese Room: 
		transport the player randomly to Swiss Cheese Room with likelihood 6
		 or to Junction Canyon with likelihood 3 or to Large Low; 
		rule succeeds.
		
	Instead of going south in Swiss Cheese Room: 
		transport the player randomly to Swiss Cheese Room with likelihood 4
		 or to Tall E/W Canyon; 
		rule succeeds. 
...
The Twopit Room is west from Swiss Cheese Room. To make is a verb.
...
The Slab Room is north from Swiss Cheese Room. To bend is a verb.
...
West from E/W Canyon is south from Secret NS Canyon. To cross is a verb.
	"[We] [are] in Secret Canyon[/b] which [here] [regarding it][run] E/W. [It] [cross] over a very tight canyon 15 feet below. If [we] [go] down [we] may not be able to get back up." 
	The printed name is "Secret Canyon".
	East is Hall of Hall of Mt King.
	E/W Canyon is towards secret from the Hall of Hall of Mt King.
...
The Junction Canyon is a room.
	...
	The printed name is "Secret Canyon".
	Up is Dusty Rock Room. Southeast is Bedquilt. 
...
East from Tall E/W Canyon is north from the Wide Place. To seem is a verb.
	...
	North is Swiss Cheese Room Room. 
	Tall E/W Canyon is towards canyon from Swiss Cheese Room.

South from Boulders is west from Tall E/W Canyon. To run is a verb.
...
The mistiness is a privately-named backdrop.
	The description is "Mist is a white vapor, usually water, seen from time to time in caverns. It can be found anywhere but is frequently a sign of a deep pit leading down to water." 
	It is in the Top of Small, Hall of Hall of Mists, East Fissure, and West Side of the Fissure.
...
The crawlability marker is a privately-named backdrop. 
	It is in West End of Hall of Mists, Dirty Passage, Pit Ledge, Entryway,
	 and Debris Room.
...
Preliminary Cave is a region. 
	Cobble Crawl, Bird Chamber, Awkward Sloping East/West Canyon, Debris Room,
	 Top of Small, and Entryway are in Preliminary Cave.

Deep Cave is a region.

	Misty Area is a region in Deep Cave. 
		Hall of Hall of Mists, East Bank of Fissure of Fissure, Nugget of Gold Room, West Side of the Fissure,
		 West End of Hall of Mists, Low Wide Passage 1, Low Wide Passage 2, East End of Long Hall,
		 and West End of Long Hall are in Misty Area.

	Mountain King's Domain is a region in Deep Cave. 
		Hall of Hall of Mt King, Low N/S Passage, Y2, West Side Chamber, South Side Chamber,
		...
		Rough Tunnels is a region in Mountain King's Domain. 
			Dirty Passage, Pit Ledge, Dusty Rock Room, and Bottom of Pit
	...
	Construction is a region in Deep Cave. 
		Complex Junction, Bedquilt, Swiss Cheese Room, Twopit Room, Large Low,
	...
	Secrets is a region in Deep Cave. 
		Secret NS Canyon, E/W Canyon, Junction Canyon, Secret N/S Canyon,
		 Wide Place, Too Tight, Tall E/W Canyon, and Boulders are in Secrets.
...
A dwarf is a kind of person. There are 3 dwarves. 
	...
	The dwarf patrol route is a list of rooms that varies. 
		The dwarf patrol route is {Dirty Passage, Low N/S Passage Passage, Hall of Hall of Mt King, West Side Chamber, Crossover, East End of Long Hall, West End of Hall of Mists, West Side of the Fissure, East of Fissure, Hall of Hall of Mists, Hall of Hall of Mt King, Low N/S Passage Passage, Dirty Passage, End of Road, End of Road, End of Road, End of Road, End of Road, End of Road, End of Road, End of Road, End of Road, End of Road, End of Road, End of Road, End of Road, End of Road, End of Road}.
...
To decide if the dwarves are awake:
	if the player has been in the Hall of Hall of Mists, decide yes;
	decide no.
...
[Removed for Inform 7 10.1.2 compatibility: cave-keyword is now defined in Table of Keywords.]
...
To say unsure facing:
	...
	Understand "right" and "[goto] right" and "go right" as a mistake
	 ("[unsure facing]") when the location is not Hall of Mt King.
	
	Understand "left" and "[goto] left" and "go left" as a mistake
	 ("[unsure facing]") when the location is not Hall of Hall of Mists
	  and the location is not Hall of Mt King.
