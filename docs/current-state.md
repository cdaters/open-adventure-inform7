...
| Author Edition | Modular IDE project export generated and transcript-verified |
...
The prototype provides a lightweight `Source/story.ni`, `Settings.plist`, and
...
Command-line project-mode verification succeeded, including project-local
extension resolution. The canonical smoke and transcript gates still pass after
the modularization.
...
- Manually confirm the Author Edition in the Inform 7 IDE.
